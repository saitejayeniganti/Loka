...
function MerchantFooter() {
    ...
    return (
        <>
            <footer>
                <div className="div1">
                    <h2 class="css-1u4uyso" style={{ marginBottom: "20px" }}>Manage Your Shop With Ease!</h2>
                    <div className="div2">
                ...
                <div className="container" style={{ marginTop: "35px" }}>
                    ...
                    <div className="row">
                        <div className="col-md-3" style={{ textAlign: "left" }}>
                            ...
                            <br />
                            <label className="txt margin15">Search for items</label>
                            <br />
                    ...
                    <a href="https://www.freepik.com/free-photo/close-up-female-business-owner-hand-hold-tablet-device-checking-inventory-stock-shop-warehouse-distributor-factory-business-ideas-concept_25192324.htm#query=manage%20inventory&position=26&from_view=search&track=sph">Image by Lifestylememory</a> on Freepik
